...
class PUICreateAccountComponent {
    ...
    installToExpress(expressApp) {
        ...
        expressApp.get(this.config.routingPrefix + '/name', this.routeYourName.bind(this))
        expressApp.post(this.config.routingPrefix + '/name', this.routeYourName.bind(this)) // TODO: handle /check-organisation POSTed data
        expressApp.get(this.config.routingPrefix + '/email', this.routeYourEmail.bind(this))
